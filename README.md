...
- Implemented a hierarchical GitOps deployment architecture included designing an ArgoCD primary instance to manage all cluster resources across 20 Kubernetes environments.
